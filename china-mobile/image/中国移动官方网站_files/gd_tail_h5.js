...
$(document).ready(function(){		
    ...
    link.setAttribute("href", "/gd_tail/foot.css");
    //如果是IE8浏览器，动态修改样式表文件
	...
	if(userAgent.indexOf("compatible")>-1&&userAgent.indexOf("MSIE")>-1&&!isOpera){
	  ...
	  if (browser == "Microsoft Internet Explorer" && trim_Version == "MSIE8.0") {
		  $(link).attr("href", "/gd_tail/ie8Tail.css");
	...
	for(var i=0;i<linksJson.length;i++){
		if("gd"!="xz" && linksJson[i].responsible == 1)continue;
	...
	imgKXYZ.src = "/gd_tail/images/knetSealLogo.png";
	imgKXYZ.width = 128;
	imgKXYZ.height = 47;
